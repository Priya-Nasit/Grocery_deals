...
<table class="table table-bordered" data-page-length='5' style="background-color:white;">
 <thead class="heading" style="background-color:#201919;color:white ">
  <tr>
   ...
   <th style="background-color:#6c757d">Product_Delivery</th>
   <th style="background-color:#6c757d">Product_Quality</th>
  <th style="background-color:#6c757d">Feedback</th>
   <th style="background-color:#6c757d">Date & Time</th>
...
{  
     ...
     echo "<td>" . $row['Product_Delivery'] . "</td>";
