...
{
  $query="select * from customer_order where Username='$name' ";
...
<table class="table table-bordered" data-page-length='5' style="background-color:white;">
 <thead class="heading" style="background-color:#201919;color:white ">
  <tr>
   ...
   <th style="background-color:#000000">Contact</th>
   <th style="background-color:#000000">Pincode</th>
   <th style="background-color:#000000">Address</th>
   <th style="background-color:#000000">Order Date</th>
   <th style="background-color:#000000">Order Time</th>
    <th style="background-color:#000000">Edit</th>
 ...
 <div align="center">
  <h2 style="color: blue"><u>Cash On Delivery</u></h2>
...
<table class="table table-bordered" data-page-length='5' style="background-color:white;">
 <thead class="heading" style="background-color:#201919;color:white ">
  ...
  <th style="background-color:#000000">Email Id</th>
   <th style="background-color:#000000">Contact</th>
  <th style="background-color:#000000">Order Date</th>
  <th style="background-color:#000000">Time</th> 
  </tr>    
  </thead>
  
 <div align="center">
  <h2 style="color: blue"><u>By Cart</u></h2>
